...
class control_pygame_show():
    ...
    def pygame_show(self):
        ...
        while True:
            ...
            reset_rect = screen.blit(reset, (490, 10))
            clear_rect = screen.blit(clear, (490, 100))
            xls_rect = screen.blit(load_excel, (490, 200))
            follow_head_rect = screen.blit(follow_head, (490, 300))
            send_messages_rect = screen.blit(handle,  (490, 400))
            pygame.draw.rect(background, (255, 255, 255, 150), (40, 40, 450, 400))
            self.show_lines()
            self.show_vel()
